...
#define UE_PROJECT_NAME PracticWorkSsnake
#define UE_TARGET_NAME PracticWorkSsnakeEditor
#define UE_MODULE_NAME "PracticWorkSsnake"
...
#define PRACTICWORKSSNAKE_API DLLEXPORT
